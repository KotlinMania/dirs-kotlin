...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Dirs.swiftmodule/`
...
//      `import Dirs` above would fail at compile time.
//
//   2. The static archive `libDirs.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Dirs" }` and
//      `flattenPackage = "io.github.kotlinmania.dirs"` configuration in
...
final class DirsExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Dirs swift module imported cleanly")
    }
}
