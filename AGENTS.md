...
This file is the quick-reference operating contract for dirs-kotlin. The longer
...
dirs-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`dirs`](https://crates.io/crates/dirs). Upstream Rust is the behavioral oracle while the
